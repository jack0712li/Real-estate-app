...
import { createListing, deleteListing, updateListing, getListing, getListings, getListingByUserId, getAllListings, countAllListings } from '../controllers/listing.controller.js';
...
router.get('/count', countAllListings);
