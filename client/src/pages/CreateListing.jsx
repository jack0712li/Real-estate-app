            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    <p className='font-semibold'>Images:
                        <spam className='font-normal text-gray-600 ml-2' >The first image will be the cover (max 6)</spam>
                    </p>
                    <div className='flex gap-4'>
                        ...
                        rounded uppercase hover:shadow-lg disabled: opacity-90'>Upload</button>
                    </div>
